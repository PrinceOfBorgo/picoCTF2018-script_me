...
port = int(sys.argv[1]) # input user argument: the port to which to connect	

print(">> Opening connection to " + BOLD + OKBLUE + host + ENDC + " on port " + BOLD + OKBLUE + str(port) + ENDC)
sock = socket.socket()
